# :page_facing_up: Myshell

## 개요
	쉘에 대한 이해도를 높이기 위해 몇 가지 기능을 수행하는 쉘 제작
...
2. 파이프 구현
	...
	* void connpipe(int *argclist, char ***argvlist, int *pfd, int count, int idx)
		...
		<br/>![Alt text](/images/21.png)

### 동작 확인
1. 리다이렉션
<br/>![Alt text](/images/22.png)
2. 파이프
	- 파이프 / 리다이렉션 연계 작동 확인 
		* working directory내 디렉토리는 1개 존재
		<br/>![Alt text](/images/23.png)
		*  백그라운드 작동 확인
		<br/>![Alt text](/images/24.png)
